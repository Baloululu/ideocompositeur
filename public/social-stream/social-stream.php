            ...
            */
            ...
            case 'instagram':
                ...
                if (@$feed_url) {
                    ...
                    if ($i == 2 || $i == 3 || ($i == 1 AND ! $use_official ) ) {
                        $get_feed = TRUE;
                        if ( ! $forceCrawl ) {
                        ...
                        if ($get_feed) {
                            ...
                            try {
                                ...
                                $instagram = $this->instagram_set_proxy();
                                ...
                                if ($i == 2) {
                                    ...
                                    if ( ! is_numeric($feed_value) ) {
                                        ...
                                        $feed_value = ( ! empty($igaccount) ) ? $igaccount[0]->getId() : null;
                                    }
                                    if ($feed_value) {
                                ...
                                foreach ($medias as $key => $media) {
                                    ...
                                    if ($user_id) {
                                        if ( empty( $account->getUsername() ) ) {
                                            ...
                                            if ( ! empty($user_info[$user_id]) && $user_info[$user_id]->status == 'ok') {
